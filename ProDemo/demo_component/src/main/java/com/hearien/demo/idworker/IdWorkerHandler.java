...
/**
 * @author 王海洋
 * @className: IdWorkerHandler
 * @description:
 * @create 2019/8/20 17:54
 **/
public class IdWorkerHandler {
    private static final Logger LOG = LoggerFactory.getLogger(IdWorkerHandler.class);
    ...
    private static class IdGenerator {
        ...
        private final static long epoch = 1457258545962L;
