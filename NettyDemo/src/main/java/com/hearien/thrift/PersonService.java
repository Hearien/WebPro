...
public class PersonService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person recv_getPersonByUserName() throws DataException, org.apache.thrift.TException
    {
      ...
      if (result.dataExeption != null) {
        throw result.dataExeption;
      }
    ...
    public static class getPersonByUserName<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUserName_args> {
      ...
      public getPersonByUserName_result getResult(I iface, getPersonByUserName_args args) throws org.apache.thrift.TException {
        ...
        try {
          ...
          result.dataExeption = dataExeption;
        }
        return result;
      }
    }
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Person>() { 
          ...
          public void onError(Exception e) {
            ...
            if (e instanceof DataException) {
              result.dataExeption = (DataException) e;
              result.setDataExeptionIsSet(true);
              msg = result;
  ...
  public static class getPersonByUserName_result implements org.apache.thrift.TBase<getPersonByUserName_result, getPersonByUserName_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUserName_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXEPTION_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExeption", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public DataException dataExeption; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SUCCESS((short)0, "success"),
      DATA_EXEPTION((short)1, "dataExeption");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 0: // SUCCESS
            return SUCCESS;
          case 1: // DATA_EXEPTION
            return DATA_EXEPTION;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_EXEPTION, new org.apache.thrift.meta_data.FieldMetaData("dataExeption", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public getPersonByUserName_result(
      Person success,
      DataException dataExeption)
    {
      this();
      this.success = success;
      this.dataExeption = dataExeption;
    }
    ...
    public getPersonByUserName_result(getPersonByUserName_result other) {
      ...
      if (other.isSetDataExeption()) {
        this.dataExeption = new DataException(other.dataExeption);
      }
    }
    ...
    public DataException getDataExeption() {
      return this.dataExeption;
    }

    public getPersonByUserName_result setDataExeption(DataException dataExeption) {
      this.dataExeption = dataExeption;
      return this;
    }

    public void unsetDataExeption() {
      this.dataExeption = null;
    }

    /** Returns true if field dataExeption is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExeption() {
      return this.dataExeption != null;
    }

    public void setDataExeptionIsSet(boolean value) {
      if (!value) {
        this.dataExeption = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case DATA_EXEPTION:
        if (value == null) {
          ...
          setDataExeption((DataException)value);
        }
        break;
    ...
    public boolean equals(getPersonByUserName_result that) {
      ...
      boolean this_present_dataExeption = true && this.isSetDataExeption();
      boolean that_present_dataExeption = true && that.isSetDataExeption();
      if (this_present_dataExeption || that_present_dataExeption) {
        if (!(this_present_dataExeption && that_present_dataExeption))
          return false;
        if (!this.dataExeption.equals(that.dataExeption))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataExeption()) ? 131071 : 524287);
      if (isSetDataExeption())
        hashCode = hashCode * 8191 + dataExeption.hashCode();
    ...
    public int compareTo(getPersonByUserName_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetDataExeption()).compareTo(other.isSetDataExeption());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExeption()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExeption, other.dataExeption);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("dataExeption:");
      if (this.dataExeption == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExeption);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getPersonByUserName_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPersonByUserName_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUserName_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // DATA_EXEPTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExeption = new DataException();
                struct.dataExeption.read(iprot);
                struct.setDataExeptionIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUserName_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.dataExeption != null) {
          oprot.writeFieldBegin(DATA_EXEPTION_FIELD_DESC);
          struct.dataExeption.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    public savePerson_result setDataExeption(DataException dataExeption) {
      this.dataExeption = dataExeption;
      return this;
    }
